    ...
    <div class="body">
		<div id="notfound">
			<div class="notfound">
				...
				<p>The page you are looking for might have been removed had its name changed or is temporarily unavailable. <router-link :to="{ name: 'home'}">Back to homepage</router-link></p>
			</div>
		</div>
    </div>
</template>
